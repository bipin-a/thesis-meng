...
def get_transferability(experiment_name,
    ...
    adv_dataset_paths = [
        f'{experiment_name}/adv_datasets/{model}/{attack}/glue_cola.csv'
    ...
    for adv_dataset_path in adv_dataset_paths:
        for model_name in inference_model_names:
            adv_result = pd.Series(
                adv_results.get((model_name,adv_dataset_path))
            )
...
def get_fidelity(experiment_name, inference_model_names, attack_names, dataset_name):
    '''
    ...
    for model in inference_model_names:
        ...
        for attack in attack_names:
            adv_dataset_path = f'{experiment_name}/adv_datasets/{model}/{attack}/{dataset_name}.csv'
