...
class InferenceAdvExamplesPipeline:
    def __init__(self, tuned_model, device, write_adv_inference_results_root):
        ...
        self.model_name = tuned_model.name_or_path.split("/")[-2]
        print("within class: ", self.model_name)
        self.tokenizer = AutoTokenizer.from_pretrained(
            self.model_name, force_download=False
        )
    ...
    def evaluate_model(self, eval_adv_dataset):
        ...
        print(self.WRITE_ADV_INFERENCE_RESULTS_ROOT)
